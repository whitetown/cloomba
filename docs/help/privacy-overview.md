...
meta_description: "How Cloomba keeps your data safe — EU hosting, GDPR compliance, passwordless auth, and your privacy rights explained."
...
We collect only what's needed to run the platform: your name, email or phone number, profile photo, and the events and RSVPs associated with your account. See [What data we collect and why](/help/data-we-collect) for the full breakdown.
...
As a user in the EU (or anywhere), you have the right to access, correct, export, and delete your data. See [GDPR & Your Rights](/legal/gdpr) for details on how to exercise them.
