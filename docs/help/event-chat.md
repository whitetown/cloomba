---
title: "The event chat"
meta_description: "Every Cloomba event has a group chat for everyone going — what it's for, who's in it, who can post, and how notifications work."
...
Every event on Cloomba has its own group chat — one thread for questions, logistics, and chatter before, during, and after the event.
...
Open the event and go to its **Chat** tab. The event chat also appears in your **Messages** list alongside your direct conversations, so you can pick it back up from there.
...
Event chats are meant to stay calm, so they're quieter than a direct message:

- You won't get a push for every message — unread messages just show up in the app.
