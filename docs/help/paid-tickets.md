---
title: "Setting up paid tickets"
meta_description: "How to create a paid ticket type on Cloomba, connect Stripe, and start collecting payments for your event."
...
Cloomba currently supports paid events in countries where Stripe Connect is available. Check [stripe.com/global](https://stripe.com/global) for the full list.
...
The exact net payout is shown in the editor before you publish, so there are no surprises. For more detail see [How Cloomba fees work](/help/pricing-fees).
