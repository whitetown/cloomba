---
title: "Why a European alternative"
meta_description: "Cloomba is built in Europe, hosted in Europe, and designed with European values — privacy by default, no VC pressure, no data harvesting."
section: "Company"
section_position: 10
position: 20
status: published
...
Cloomba runs on infrastructure in the **European Union** — EU West, Amsterdam. Your data and your attendees' data never leaves the EU as part of our core operations. That is not a setting you have to find or a tier you have to pay for. It is just how it works.
...
We are WhiteTown s.r.o., a small software company based in Bratislava, Slovakia. We are not a faceless platform. You can reach us directly, and we actually respond.

Cloomba is our bet that there is a real place for a calm, honest, European-made alternative in a market dominated by platforms that have forgotten who they are supposed to serve.
